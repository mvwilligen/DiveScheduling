...
def htmlexport():
    ...
    import shutil
    aFiles = []
    aFiles.append(['./Exports/logo.png',     cFolderNameOSHtml     + 'logo.png'])
    aFiles.append(['./Exports/logo.png',     cFolderNameOSInternal + 'logo.png'])
    aFiles.append(['./Exports/calendar.png', cFolderNameOSHtml     + 'calendar.png'])
    aFiles.append(['./Exports/calendar.png', cFolderNameOSInternal + 'calendar.png'])
    aFiles.append(['./Exports/favicon.ico',  cFolderNameOSHtml     + 'favicon.ico'])
    aFiles.append(['./Exports/favicon.ico',  cFolderNameOSInternal + 'favicon.ico'])
