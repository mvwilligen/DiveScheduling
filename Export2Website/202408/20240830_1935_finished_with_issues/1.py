...
U6.Passwordhash = generate_password_hash(U6.Firstname)
...
U7.Passwordhash = generate_password_hash(U7.Firstname)
...
U8.Passwordhash = generate_password_hash(U8.Firstname)
...
U9.Passwordhash = generate_password_hash(U9.Firstname)
...
U10.Passwordhash = generate_password_hash(U10.Firstname)
with app.app_context():
    db.session.add(U)
    db.session.add(U0)
    db.session.add(U1)
