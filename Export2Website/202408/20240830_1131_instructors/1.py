...
U = Users(Username = "Admin",      Lastname = "Ad",            Firstname = "Min",      Phone = "06-12000000", Passwordhash = pwhash, Emailaddress = "Admin@mwisoftware.nl",      Status = "admin, staff")
U0 = Users(Username = "-",         Lastname = "-",             Firstname = "-",        Phone = ""           , Passwordhash = pwhash, Emailaddress = "",                          Status = "")
U1 = Users(Username = "Laura",     Lastname = "Maissan",       Firstname = "Laura",    Phone = "06-23000000", Passwordhash = pwhash, Emailaddress = "laura@mwisoftware.nl",      Status = "admin, staff, instructor")
U2 = Users(Username = "Vincent",   Lastname = "Maissan",       Firstname = "Vincent",  Phone = "06-34000000", Passwordhash = pwhash, Emailaddress = "vincent@mwisoftware.nl",    Status = "staff, instructor")
U3 = Users(Username = "Jeroen",    Lastname = "Maissan",       Firstname = "Jeroen",   Phone = "06-34000000", Passwordhash = pwhash, Emailaddress = "jeroen@mwisoftware.nl",     Status = "staff, instructor")
U4 = Users(Username = "Marga",     Lastname = "Maissan",       Firstname = "Marga",    Phone = "06-34000000", Passwordhash = pwhash, Emailaddress = "marga@mwisoftware.nl",      Status = "staff, instructor")
U5 = Users(Username = "Monique",   Lastname = "van der Linde", Firstname = "Monique",  Phone = "06-34000000", Passwordhash = pwhash, Emailaddress = "Monique@mwisoftware.nl",    Status = "staff, instructor")
U6 = Users(Username = "Annelies",  Lastname = "L",             Firstname = "Annelies", Phone = "06-45000000", Passwordhash = pwhash, Emailaddress = "Anneliesl@mwisoftware.nl",  Status = "student")
U7 = Users(Username = "Bea",       Lastname = "L",             Firstname = "Bee",      Phone = "06-56000000", Passwordhash = pwhash, Emailaddress = "Beal@mwisoftware.nl",       Status = "student")
U8 = Users(Username = "Caroline",  Lastname = "dG",            Firstname = "Caar",     Phone = "06-67000000", Passwordhash = pwhash, Emailaddress = "Carolinedg@mwisoftware.nl", Status = "student")
U9 = Users(Username = "Debora",    Lastname = "vL",            Firstname = "Debora",   Phone = "06-78000000", Passwordhash = pwhash, Emailaddress = "deboravl@mwisoftware.nl",   Status = "student")
U10 = Users(Username = "Evelien",  Lastname = "K",             Firstname = "Evelien",  Phone = "06-89000000", Passwordhash = pwhash, Emailaddress = "evelienk@mwisoftware.nl",   Status = "student")
with app.app_context():
    db.session.add(U)
    db.session.add(U0)
    db.session.add(U1)
