...
def homepage():
    ...
    nDateTo  = datetime.date.today() + timedelta(days=15)
...
# 2024-08-30
        ...
        x.Date  = dDate
        x.Notes = cStaff + ' | ' + cDate + ' | ' + cTime + ' | ' + dDateText + ' | ' + dDate.strftime('%Y-%m%d %H.%M')
        db.session.commit()
