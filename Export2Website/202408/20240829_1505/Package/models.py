...
class Appointments(db.Model):
    ...
    Staff   = db.Column(db.Integer(),          ForeignKey('Instructors.Id'),   nullable=True,  unique=False) # 1

    app2nam = relationship('Users',       back_populates = 'Appointments')
    app2pro = relationship('Products',    back_populates = 'Appointments')
    app2ins = relationship('Instructors', back_populates = 'Appointments') # 2
...
class Instructors(db.Model):
    ...
    Appointments  = relationship('Appointments', back_populates = "app2ins") # 3
