...
def htmlexport():
    ...
    for nYears in range(nYearFrom, nYearTo + nAddYear):
        ...
        for nMonths in range(nMonthFrom, nMonthTo):
            ...
            if True:
                ...
                cHtmlCal = cHtmlCal + "<table><tr><td colspan=8 align='center'>" + lMonthNames [nMonth] + "</td></tr>"
                ...
                for nDays in range(nLastDay):
                    ...
                    for a in appointments:
                        ...
                        # date html
                        cHtmlIns = cHtmlIns + '<tr><td>' + a [6].strftime('%H.%M') + cWhiteSpace  + '</td><td>' + a [4] + cWhiteSpace + '</td><td>'  + a [5] + cWhiteSpace + '</td><td>'  + a [2] + ' ' + a [3] + cWhiteSpace + '</td><td>' + a [8] + cWhiteSpace + '</td>' + chr(13) + chr(10)
                        ...
                        if not a [4] in cProducts:
                            cHtmlCal = cHtmlCal + '<a href=' + cFolderNameHtml + 'calendar_' + cDate3 + '.html>' + a [4] + '</a><br>'
                    ...
                    cHtmlCal = cHtmlCal + '<br>' + cWhiteSpace2
                    ...
                    if len(cHtmlIns) > 0:
                        # date html
                        cHtmlIns2 = '<html>' + cStyle + '<body>[cInstructorsMenu]<br><br><table>'
                        cHtmlIns2 = cHtmlIns2 + '<tr><td colspan = 5>' + str(nDay) + ' ' + lMonthNames[nMonth] + ' ' + str(nYear) + ' - [NameOfDay]</td></tr>'
                        cHtmlIns2 = cHtmlIns2 + '<tr><td><b>time</b><td><b>product</b><td><b>part</b><td><b>student</b><td><b>instructor</b></td><tr>'
                        cHtmlIns2 = cHtmlIns2 + cHtmlIns
                        cHtmlIns2 = cHtmlIns2 + '</table>'

                        cFileName = cFolderNameOS + '/calendar_' + cDate3 + '.html'

                        aHtmlFiles.append([cFileName, cHtmlIns2])
    ...
    print('cNewInstructorsMenu: ', cNewInstructorsMenu)
    ...
    for i in aInstructor:
        ...
        cHtmlIns = '<html>' + cStyle + '<body>[cInstructorsMenu]<br><br><table><tr><td colspan=4 align=center>' + i [2] + '</td></tr>' + i [3] + '</table>'
    ...
    for h in aHtmlFiles:
        ...
        # add footer
        cHtml = cHtml + '<br><br><p>powered by divescheduling. created:' + cDate5 + ' ' + cTime2 + '</p></body></html>'
