...
def htmlexport():
    ...
    cHeader = "<!--BeginCut --><table style='border-style: hidden;'><tr><td style='border:none;'><a href='http://127.0.0.1:5000/'><img src='logo.png' alt='ds'></a></td><td style='border:none;'>" + cCRLF
    ...
    # if not os.path.exists(cFolderNameOSMail):
    #     os.makedirs(cFolderNameOSMail) 
    ...
    # dst = cFolderNameOSMail + 'logo.png'
    # print('src: ', src)
    # print('dst: ', dst)
    # shutil.copyfile(src, dst)

    dst = cFolderNameOSInternal + 'logo.png'
    print('src: ', src)
    print('dst: ', dst)
    shutil.copyfile(src, dst)
