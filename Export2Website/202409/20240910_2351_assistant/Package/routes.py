...
def htmlexport():
                ...
                for nDays in range(nLastDay):
                    ...
                    for a in appointments:
                        ...
                        if len(a[11]) > 0:
                            ...
                            if not a[11] in cInstructorsMenu:
                                print ('a[11]:  ', a[11])
    ...
    cHeader = "<!--BeginCut --><table style='border-style: hidden;'><tr><td style='border:none;'><a href='http://127.0.0.1:5000/' target=”_blank”>"
    cHeader = cHeader + "<img src='logo.png' alt='ds'></a></td><td style='border:none;'><a href='index.html'>Calendar</a></td><td style='border:none;'>" + cCRLF
