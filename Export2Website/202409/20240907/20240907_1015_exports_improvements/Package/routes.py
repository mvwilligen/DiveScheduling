    ...
    for nMonth in range(12):
        if nMonth >= nMonthFrom and nMonth <= nMonthTo:
            ...
            for nDay in range(nLastDay):
                ...
                for a in appointments:
                    cHtml2 = cHtml2 + '<tr><td>' + a [6].strftime('%H.%M') + cWhiteSpace  + '</td><td>' + a [4] + cWhiteSpace + '</td><td>'  + a [5] + cWhiteSpace + '</td><td>'  + a [2] + ' ' + a [3] + cWhiteSpace + '</td><td>' + a [8] + cWhiteSpace + '</td><td>' + chr(13) + chr(10)
