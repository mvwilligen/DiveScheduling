...
def htmlexport():
    ...
    for i in aStudentHtml:
        ...
        cHtmlIns = "<html>" + cHead + cStyle + "<body>[cInstructorsMenu]<br><br><table><tr><td colspan=5 style='text-align: center;'><h3 style='margin-bottom: 0;'>" + i [2] + "</h3></td></tr>" + i [3] + "</table>"
    ...
    cHeader = "<!--BeginCut --><table style='border-style: hidden;'><tr><td style='border:none;'><a href='http://127.0.0.1:5000/' target=”_blank”><img src='logo.png' alt='ds'></a></td><td style='border:none;'>" + cCRLF
    ...
    src = 'C:/Data/Python/DiveScheduling/Exports/favicon.ico'
    dst = cFolderNameOSInternal + 'favicon.ico'
    print('src: ', src)
    print('dst: ', dst)
    shutil.copyfile(src, dst)

    src = cFolderNameOSInternal + "*"
