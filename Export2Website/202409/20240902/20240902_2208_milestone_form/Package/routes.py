...
from Package.forms import AppointmentsEditForm, LoginForm, ProductsEditForm, ProductsUsersForm, ProductsNewForm, UsersEditForm, UsersInfoForm, RegisterForm, RegisterForm2, UsersProductForm2
