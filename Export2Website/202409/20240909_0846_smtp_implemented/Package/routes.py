...
def htmlexport():
    ...
    cStyle = '<style>' + chr(13) + chr(10)
    cStyle = cStyle + 'td { text-align:left; vertical-align:top; padding-left:5px;padding-right:5px;padding-bottom:5px;padding-top:5px;' + chr(13) + chr(10)
    cStyle = cStyle + 'font-family:verdana; }' + chr(13) + chr(10)
    cStyle = cStyle + 'table { border-collapse: collapse; }' + chr(13) + chr(10)
    cStyle = cStyle + 'a, p, h3 {font-family:verdana;}' + chr(13) + chr(10)
    cStyle = cStyle + 'table, th, td { border: 1px solid};' + chr(13) + chr(10)
    cStyle = cStyle + '</style>' + chr(13) + chr(10)
    cStyle = cStyle + '' + chr(13) + chr(10)

    cHtmlCal = '<html>' + cStyle + '<body>[cInstructorsMenu]<br>' + chr(13) + chr(10)
    ...
    for nYears in range(nYearFrom, nYearTo + nAddYear):
        ...
        for nMonths in range(nMonthFrom, nMonthTo):
            ...
            if True:
                ...
                cHtmlCal = cHtmlCal + "<table><tr><td colspan=8 style='text-align: center;'><h3 style='margin-bottom: 0;'>" + lMonthNames [nMonth] + "</h3></td></tr>"
                ...
                for nDays in range(nLastDay):
                    ...
                    for a in appointments:
                        ...
                        # html student
                        cAddHtmlLine = "<tr><td>" + a [6].strftime("%d-%m-%Y %H:%M") + cWhiteSpace + "</td><td>" + a [4] + cWhiteSpace + "</td><td>" + a [5] + cWhiteSpace + "</td><td>" + a [2] + " " + a [3] + cWhiteSpace + "</td><td>" + a [8] + cWhiteSpace + "</td></tr>"
                    ...
                    if len(cHtmlDat) > 0:
                        ...
                        cHtmlDat2 = cHtmlDat2 + "<tr><td colspan=5 style='text-align: center;'><h3 style='margin-bottom: 0;'>" + str(nDay) + " " + lMonthNames[nMonth] + " " + str(nYear) + " - " + cWeekdayName + "</h3></td></tr>"
